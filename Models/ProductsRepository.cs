namespace WebApp.Models
{
    public class ProductsRepository
    {
        ...
        public static void AddProduct(Product product)
        {
            ...
            _products ??= new List<Product>(); // if(_products==null) _products=new List<Product>();
        ...
        public static Product? GetProductById(int productId, bool loadCategory = false)
        {
            ...
            if (product != null)
            {
                ...
                {
                    int categoryId = prod.CategoryId.Value;
                    prod.Category = CategoriesRepository.GetCategoryById(categoryId);
                }
                return prod;
            }
            return null;
        ...
        public static List<Product> GetProductsByCategoryId(int catId)
        {
            var products = _products.Where(x => x.CategoryId == catId);
